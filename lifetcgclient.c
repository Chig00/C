...
#define Messenger Client
#define messenger_send client_send
#define messenger_read client_read
#define messenger client
#define flip (1 - coin_flip())
...
/* A card game based on the PTCG, but using
   ...
   This is the client-side version of the program
 */
int main(int argc, char* argv[]) {
	...
	// The RNG seed is obtained
	client_read(&client, message, BUFFER_SIZE);
	int seed;
	sscanf(message, "%d", &seed);
	...
	// The client and SDL are shut down
	client_quit(&client);
	sdlnet_quit();
